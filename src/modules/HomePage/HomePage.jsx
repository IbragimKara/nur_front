    ...
    <div className={s.main}>
      <div className={s.main__contener}>
        ...
        <div className={s.main__block}>
          <h1 className={s.main__title} >Качественные кухонные столешницы из изскуственого камня кварц, акрил </h1>
          <div className={s.main__content}>
            <h2 className={s.main__subtitle}>Запишитесь на бесплатный замер и мы привезем более 1000 образцов камня к вам домой</h2>
